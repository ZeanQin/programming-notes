...
showTree :: (Show a) => Mtree a -> String
showTree (Mnode a nodes) = 
  "" ++ show a ++ "\n" ++ concatMap showTree nodes

result = showMtree (Mnode 1 [Mnode 2 [], Mnode 3 [Mnode 4 []]])
result2 = showTree (Mnode 1 [Mnode 2 [], Mnode 3 [Mnode 4 []]])
